...
def salvar_dataset_csv(estatisticas, caminho_csv='espso_base_canto_round_robin2.csv'):
...
def visualizar_pso_com_trajetoria(nos, CHs, clusters, edges, sink, rodada=None):
    ...
    # Arestas dos clusters (MST intra-cluster)
    for ch, membros in clusters.items():
    ...
    titulo = 'Ec-PSO - Visualização dos Clusters'
...
def main(metodo_reeleicao='round_robin'):
    ...
    posicao_inicial_sink = StaticSink((0, 0))
